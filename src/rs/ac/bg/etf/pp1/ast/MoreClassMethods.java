...
public class MoreClassMethods extends ClassMethodList {

    private ClassMethodList ClassMethodList;
    private MethodDecl MethodDecl;

    public MoreClassMethods (ClassMethodList ClassMethodList, MethodDecl MethodDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MoreClassMethods(\n");
